...
import EditApproverModal from "@/components/approver/edit-modal"; // <-- Pastikan path benar
        ...
        <CardContent>
          {loading ? (
            ...
            <DataTable 
              ...
              onEdit={handleEdit} // <-- KUNCI: Pass fungsi edit ke sini
            />
          )}
        </CardContent>
      </Card>
